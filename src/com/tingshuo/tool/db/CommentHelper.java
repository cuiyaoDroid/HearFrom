...
public class CommentHelper extends DBHelper {
	private final static String TABLE_NAME = "comment_order";
	...
	public long insert(CommentHolder content, SQLiteDatabase db) {
	...
	private CommentHolder getDataCursor(Cursor cursor) {
	...
	public ArrayList<CommentHolder> selectData(int post_id,int from,int pagesize,int role_id,int sex) {
		...
		for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
			CommentHolder holder=getDataCursor(cursor);
			holderlist.add(holder);
		}
		cursor.close();
		return holderlist;
	}
	public ArrayList<CommentHolder> selectSearchData(String num) {
		SQLiteDatabase db = this.getReadableDatabase();
	...
	public CommentHolder selectData_Id(int v_id) {
		SQLiteDatabase db = this.getReadableDatabase();
