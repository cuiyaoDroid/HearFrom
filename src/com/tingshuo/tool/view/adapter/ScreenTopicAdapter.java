...
public class ScreenTopicAdapter extends BaseAdapter {
	...
	public ScreenTopicAdapter(Context context, List<? extends Map<String, Object>> list) {
		this.list = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.cell_screen_topic, null);
