 ...
 */
public class PinnedHeaderExpandListView extends ExpandableListView {
	...
	public PinnedHeaderExpandListView(Context context) {
		super(context);
	}

	public PinnedHeaderExpandListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
