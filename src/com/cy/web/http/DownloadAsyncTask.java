...
import com.cy.hearfrom.HearFromApp;
import com.cy.tool.FileNameTool;
...
public class DownloadAsyncTask extends AsyncTask<String, Integer, Boolean> {
	...
	protected Boolean doInBackground(String... params) {
		try {
			...
			HttpGet httpRequest = new HttpGet(HttpJsonTool.ServerUrl
					+ params[0] + "?" + content);
			L.i("httpdownload", HttpJsonTool.ServerUrl + params[0] + "?"
					+ content);
